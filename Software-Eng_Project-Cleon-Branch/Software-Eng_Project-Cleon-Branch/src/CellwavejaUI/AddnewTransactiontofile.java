		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				for (int i=0; i<addproductinformationGUI.newProducts.size(); i++){
					if(textField_2ProductName.getText().equals(addproductinformationGUI.newProducts.get(i).getProductName())&&textField_7ProductModelNumber.getText().equals(addproductinformationGUI.newProducts.get(i).getModelNumber())&&textField_4ProductType.getText().equals(addproductinformationGUI.newProducts.get(i).getProductType())&&textField_6Colour.getText().equals(addproductinformationGUI.newProducts.get(i).getColour())) {
						right=1;
						if(addproductinformationGUI.newProducts.get(i).getQuantity()<=0) {
							right=2;
						}
					}
				}
